...
<fmt:message bundle="${b}" key="reg.forgotAuthorized" var="forgotAuth"/>
<fmt:message bundle="${b}" key="reg.Auth" var="auth"/>
...
<section class="content login-content">
    <div class="field">
        <form class="card login-card" onsubmit="return validateEmail()"
            ...
            <div class="field">
                <input type="hidden" name="command" value="confirm_authorisation">
            </div>
            <div class="field">
