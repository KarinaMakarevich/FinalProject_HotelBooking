...
public class ApproveOrderCommand extends AbstractCommand {
    ...
    public ApproveOrderCommand(Receiver receiver) {
        super(receiver);
    }
    ...
    public Router execute(RequestContent requestContent) {
        ...
        try {
            receiver.doAction(CommandType.APPROVE_ORDER, requestContent);
            ...
            if (!set.contains(GeneralConstant.ErrorConstant.ERROR)) {
                ...
                LOGGER.log(Level.INFO, "Approve room command was successful");
            } else {
            ...
            router.setPath(GeneralConstant.CommonPageConstant.ERROR_PAGE);
            router.setType(RouterType.FORWARD);
            LOGGER.log(Level.ERROR, "Error with approve room command: " + e.getMessage());
        }
        return router;
    }
}
